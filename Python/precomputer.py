...
smaller_images = {
    "image1": (cv2.imread(curr_dir+"/Python/marker.jpeg", cv2.IMREAD_GRAYSCALE), *akaze.detectAndCompute(cv2.imread(curr_dir+"/Python/marker.jpeg", cv2.IMREAD_GRAYSCALE), None)),
    "image2": (cv2.imread(curr_dir+"/Python/marker7.jpeg", cv2.IMREAD_GRAYSCALE), *akaze.detectAndCompute(cv2.imread(curr_dir+"/Python/marker7.jpeg", cv2.IMREAD_GRAYSCALE), None)),
